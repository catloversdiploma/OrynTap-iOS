...
//  OrynTap
//
//  Created by Тынысбек Жанагуль on 26.04.2023.
//
...
struct CustomSegmentedPicker: View {
    ...
    init(selection: Int = 0, titles: [String], selectedItemColor: Color, backgroundColor: Color, selectedItemFontColor: Color, defaultItemFontColor: Color) {
